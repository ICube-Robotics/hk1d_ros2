...
#include "test_hk1d_mock_pyrobot.hpp"
...
void TestHk1DMockPyrobot::SetUpTestCase() { rclcpp::init(0, nullptr); }

void TestHk1DMockPyrobot::TearDownTestCase() { rclcpp::shutdown(); }

void TestHk1DMockPyrobot::SetUp()
{
  controller_ = std::make_unique<FriendHk1DMockPyrobot>();
}

void TestHk1DMockPyrobot::TearDown() { controller_.reset(nullptr); }

void TestHk1DMockPyrobot::SetUpController()
{
  const auto result = controller_->init("test_hk1d_mock_pyrobot");
...
TEST_F(TestHk1DMockPyrobot, ConfigureAndActivateParamsSuccess)
{
  SetUpController();
...
TEST_F(TestHk1DMockPyrobot, NoCommandCheckTest)
{
  SetUpController();
